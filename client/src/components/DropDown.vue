<template>
    ...
    <div v-if="isOpen" class="z-10 rounded-md bg-white shadow-md w-full transition overflow-hidden">
        <ul class="divide-y divide-gray-200">
            <li v-for="(item, index) in menuOptions" :key="index"
                ...
                @click="handleClick(item)" :class="{'hover:cursor-not-allowed text-gray-500' : item != 'Random'}">
